...
public class DataManager : MonoBehaviour, IGameManager{
    ...
    public void SaveGameState()
    {
        ...
        formatter.Serialize(stream, gamestate); // Сериализуем
        stream.Close();
    }
    ...
    public void LoadGameState()
    {
        ...
        Managers.Inventory.UpdateData((Dictionary<string, int>)gamestate["inventory"]); // Обновляем диспетчеры, снабжая их данными
